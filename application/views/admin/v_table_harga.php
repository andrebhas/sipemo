        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-primary" href="<?php echo site_url()?>/admin/c_harga_mobil/tambah/">Tambah Data</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                          ...
                                          <td><a class="btn btn-warning btn-circle fa fa-link" href="<?php echo site_url('admin/c_harga_mobil/update/'.$dataa->id) ?>"></a>
                                          </td>
                                    </tbody>
                                       <?php
                                    }
