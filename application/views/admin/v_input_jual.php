                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Tambah Nilai Purna Jual
                        </div>                        
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="<?php echo base_url(). 'admin/c_purna_jual/tambah_aksi'; ?>" role="form" method="post">
                                        <div class="form-group">
                                            <label>Purna Jual</label>
                                            <input type="number" id="range_harga" name="range_harga" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="nilai" name="nilai" class="form-control" required="required">
                                                ...
                                                foreach ($sub_purna_jual as $d) {
                                                    echo '<option value="'.$d->id_purna_jual.'">'.$d->nilai.'</option>';
                                                }
                                                ?>
                                            </select>
