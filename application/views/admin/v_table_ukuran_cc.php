        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-primary" href="<?php echo site_url()?>/admin/c_ukuran_cc/tambah/">Tambah Data</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                          ...
                                          <td><a class="btn btn-warning btn-circle fa fa-link" href="<?php echo site_url('admin/c_ukuran_cc/update/'.$dataa->id_ukuran_cc) ?>"></a>
                                          </td>
                                    </tbody>
                                       <?php
                                    }
